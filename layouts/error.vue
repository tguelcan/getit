    ...
    <div class="flex h-screen bg-primary">
        <div class="m-auto text-center">
            <div class="w-64 mx-auto">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 463 420">
                    <path
            ...
            <div v-if="error.statusCode === 404">
                <h1 class="text-2xl font-bold text-white my-4">
                    Content not found
                </h1>
            </div>
            ...
            <g-button color="alternate" link @click="backToHome"
                >Back to home</g-button
            >
        </div>
    </div>
</template>
